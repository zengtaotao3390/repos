...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td>
      <input type="text" name="queryString" maxlength="140" value="" /><input type="submit" value="搜索" />
    <</td>
  </tr>
</table></td>
    <td width="15%">&nbsp;</td>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="30" cellpadding="0">
             ...
             <tr>
                <td colspan="3" valign="middle"><div align="left" class="STYLE14" >商家登录</div></td>
                </tr>
              <tr>
                <td  class="STYLE16" valign="middle">商家姓名：</td>
                <td colspan="2"><input name="username" type="text" size="30"/></td>
              </tr>
              <tr>
                <td  class="STYLE16" valign="middle">商家密码：</td>
              ...
              <tr class="STYLE16">
                <td colspan="3" valign="middle"><div align="center"><input type="submit" name="Submit" value="登录" />|<input type="reset" value="重置"/></div></td>    
                </tr>
