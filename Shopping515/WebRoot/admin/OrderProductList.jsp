...
--></style>
	...
	<%
	 ...
	 %>
<form action="goods.do?flag=10" name="form1" id="form1" method="post" target="main">
			...
			<tbody>
				...
				<tr class="smalltxt" bgcolor="" >
													<td class="header" colspan="8">
														...
														%>
														当前<%=currentePage%>页
														<a  target="main" href="goods.do?flag=10&currentePage=<%=currentePage + 1 %>">下一页&gt</a>
														<a href="goods.do?flag=10&currentePage=<%=maxPage%>">尾页</a>
														<%
															} else if (currentePage == maxPage) {
														%>
														当前<%=currentePage%>页
														<a target="main" href="goods.do?flag=10&currentePage=1">首页</a>
														<a target="main" href="goods.do?flag=10&currentePage=<%=currentePage - 1%>">&lt上一页</a>

														<%
															} else {
														%>
														<a target="main" href="goods.do?flag=10&currentePage=1">首页</a>
														<a href="goods.do?flag=10&currentePage=<%=currentePage - 1 %>" >&lt上一页</a>

														当前<%=currentePage%>页
														<a target="main" href="goods.do?flag=10&currentePage=<%=currentePage + 1%>">下一页&gt</a>
														<a target="main" href="goods.do?flag=10&currentePage=<%=maxPage%>">尾页</a>
														<%
															}
														%>
