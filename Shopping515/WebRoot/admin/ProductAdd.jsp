...
<br>
<form method="post" name="formAdd" id="form1" action="" onsubmit="">
...
<td class="altbg2"><input name="goodsName" size="25" maxlength="25" type="text"> 
</tr>

<tr>
<td class="altbg1">市场价格:</td>
<td class="altbg2"><input name="goodsPrice" size="25" type="text"></td>
</tr><tr>
<td class="altbg1">折扣（如五折0.5）:</td>
<td class="altbg2"><input name="goodsDiscount" size="25" type="text"></td>
</tr>

<tr>
<td class="altbg1" valign="top">产品描述:</td>
<td class="altbg2"><textarea name="goodsIntroduction" cols="60" rows="5" id="descr"></textarea></td>
</tr>
</tbody></table>
<br>
<center><input name="regsubmit" value="添 &nbsp;加" type="button" onclick="tosubmit()"></center>
</form>
