			...
			<tbody>
				...
				<tr>
					<td colspan="5" class="altbg2">
						搜索用户名
						<input size="15" name="keyword" type="text" id="keyword">
						<input value="提 &nbsp; 交" type="button" name="keyword" id="keyword" onclick="tosubmit1()" >
						&nbsp; &nbsp;
											...
											<tbody>
												<tr class="smalltxt" bgcolor="">
													<td class="header">
														...
														%>
														当前<%=currentePage%>页
														<a  target="main" href="user.do?flag=3&currentePage=<%=currentePage + 1 %>">下一页&gt</a>
														<a href="user.do?flag=3&currentePage=<%=maxPage%>">尾页</a>
														<%
															} else if (currentePage == maxPage) {
														%>
														当前<%=currentePage%>页
														<a target="main" href="user.do?flag=3&currentePage=1">首页</a>
														<a target="main" href="user.do?flag=3&currentePage=<%=currentePage - 1%>">&lt上一页</a>

														<%
															} else {
														%>
														<a target="main" href="user.do?flag=3&currentePage=1">首页</a>
														<a href="user.do?flag=3&currentePage=<%=currentePage - 1 %>" >&lt上一页</a>

														当前<%=currentePage%>页
														<a target="main" href="user.do?flag=3&currentePage=<%=currentePage + 1%>">下一页&gt</a>
														<a target="main" href="user.do?flag=3&currentePage=<%=maxPage%>">尾页</a>
														<%
															}
														%>

														共有<%=maxPage%>页 &nbsp;第
														<input type="text" size="4" name="currentePage" />页
